        ...
        dbc.Container(
            [
                dbc.Col([
                    ...
                    dbc.Row(daq.LEDDisplay(id='temp_led', label="", value=0, color=theme['secondary'],
                                           className='dark-theme-control ml-5 p-3')),
                ]),
                dbc.Col([
                    dbc.Row(daq.Gauge(id="daq_pression", size=200, min=0, max=10, value=6, label="Pression")),
                    dbc.Row(daq.LEDDisplay(id='pression_led', label="", value=0, color=theme['secondary'],
                                           className='dark-theme-control ml-5 p-3')),
                ]),
                dbc.Col([
...
], style={'height': '70vh', 'marginLeft': '10px', 'marginTop': '25px'}),
                ...
                [
                    ...
                    dcc.Checklist(
                        ...
                        labelStyle={'display': 'inline-block',
                                    'background': '#2b95ff',
                                    # style of the <label> that wraps the checkbox input and the option's label
...
card_map = dbc.Card([
    dl.Map([dl.TileLayer(),
            dl.LocateControl(options={'locateOptions': {'enableHighAccuracy': True}}, startDirectly=True),
            dl.GeoJSON(data=fc_lab)],
           id="map", zoom=10, style={'width': '100%', 'height': '70vh', 'margin': "auto", "display": "block"}),
], style={'height': '70vh', 'marginRight': '10px', 'marginTop': '20px'})
...
welcome_meteo_layout = html.Div([
                ...
                [
                    html.Div(
                        [
                            ...
                            html.Div(
                                children='Données météorologiques et géographiques au FC Lab ',
    ...
    dbc.Row([dbc.Col(card_infomap, width=12)])
])
